...
BTAD_DIR = './datasets/btad'


def load_btad(category, k_shot, experiment_indx):
    def load_phase(root_path, gt_path):
        ...
        for defect_type in defect_types:
            ...
            if defect_type == 'ok':
                ...
                img_paths.extend(glob.glob(os.path.join(defect_path) + "/*.JPG"))
                img_paths.extend(glob.glob(os.path.join(defect_path) + "/*.bmp"))
                ...
                tot_types.extend(['defect'] * len(img_paths))
    ...
    test_img_path = os.path.join(BTAD_DIR, category, 'test')
    train_img_path = os.path.join(BTAD_DIR, category, 'train')
    ground_truth_path = os.path.join(BTAD_DIR, category, 'ground_truth')
